...
func RegisterTables() {
	...
	err := db.AutoMigrate(
		...
		system.SysApiToken{},
		system.SysLoginLog{},
		system.SysSenderEmailAccount{},
		system.SysEmailTemplateFolder{},
		system.SysEmailTemplate{},
		system.SysContact{},
		system.SysContactList{},
		system.SysContactListItem{},
		system.SysContactImportJob{},
		system.SysContactImportRowError{},
		system.SysEmailVerifyJob{},
